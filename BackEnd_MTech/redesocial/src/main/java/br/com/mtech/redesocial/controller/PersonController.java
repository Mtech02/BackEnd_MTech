...
import br.com.mtech.redesocial.repository.PersonRepository;
...
public class PersonController {
	...
	/*Faz uma busca atraves do CPF/CNPJ, trazendo a informações da pessoa
	 * ou empresa.
	 */
	@GetMapping("/{id}")
	public ResponseEntity<PersonModel> getById(@PathVariable long id){
	...
	public ResponseEntity<List<PersonModel>> getByName(@PathVariable String name){
	...
	@PostMapping
	public ResponseEntity<PersonModel> post(@RequestBody PersonModel person){
